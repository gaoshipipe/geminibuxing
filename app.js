...
const UUID = process.env.UUID || 'b4813a37-1c82-4541-b8e6-0f86c2f8c4b3'; // UUID
...
const DOMAIN = process.env.DOMAIN || 'jiushipipe-laonewbee.hf.space';   // 必填项，hug分配的域名或workers反代后的域名,例如：xxx.abc-hf.space 
