...
const UUID = process.env.UUID || '7ef3421d-0ee1-4866-86a1-8087b61510c8'; // UUID
...
const DOMAIN = process.env.DOMAIN || 'jiushipipe-newbeexp.hf.space';   // 必填项，hug分配的域名或workers反代后的域名,例如：xxx.abc-hf.space 
