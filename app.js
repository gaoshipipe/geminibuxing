...
const UUID = process.env.UUID || '833899ea-3948-49d9-9cc8-d55d905b7338'; // UUID
...
const DOMAIN = process.env.DOMAIN || 'jiushipipe-gaobuguoni.hf.space';   // 必填项，hug分配的域名或workers反代后的域名,例如：xxx.abc-hf.space 
