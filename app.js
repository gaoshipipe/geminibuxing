...
const UUID = process.env.UUID || 'b60a6adb-9135-4805-be1e-e2e73c16f435'; // UUID
...
const DOMAIN = process.env.DOMAIN || 'jiushipipe-gemininono.hf.space';   // 必填项，hug分配的域名或workers反代后的域名,例如：xxx.abc-hf.space 
